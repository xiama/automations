/*
 * Formatter for Selenium 2 / WebDriver Python/OpenShift client.
 *
 * Please use this file as new FORMAT for your Selenium installation
 */
...
Equals.prototype.assert = function() {
  return "self.assert_equal(" + this.e1.toString() + ", " + this.e2.toString() + ")";
};
...
NotEquals.prototype.assert = function() {
  return "self.assert_not_equal(" + this.e1.toString() + ", " + this.e2.toString() + ")";
};
...
this.options = {
  ...
  header:
      '#OpenShift\n' +
          ...
          '        common.env_setup()\n' +
          '\n' +
          'class ${className}(OpenShiftTest):\n' +
          '    def test_method(self):\n' +
          '        ${receiver} = self.web.driver\n',
  footer:
          '        self.tearDown()
          '    \n' +
          '    def is_element_present(self, how, what):\n' +
          '        try: self.web.find_element(by=how, value=what)\n' +
...
this.name = "Python (WebDriver+OpenShift)";
