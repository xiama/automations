...
class SignInWithoutAcceptTerms(OpenShiftTest):
    def test_method(self):
        ...
        return self.passed(" case_122230--SignInWithoutAcceptTerms passed successfully.")
...
def get_suite(conf):
    ...
    suite.add_test(SignInWithoutAcceptTerms)
    return suite
