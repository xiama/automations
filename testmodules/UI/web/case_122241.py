...
class Login_logout_return(OpenShiftTest):
    def test_method(self):
        ...
        return self.passed("Case 122241 test passed.")
...
def get_suite(conf):
    ...
    suite.add_test(Login_logout_return)
    return suite
