...
class OpenShiftTest(rhtest.Test):
    ...
    def initialize(self):
        self.summary = "[US1386][Runtime][cartridge]Embed PostgreSQL-9.2 cartridge to {rack, perl, wsgi, php, jbossas, jbosseap, nodejs} app"
        try:
...
class PostgresqlUsage(OpenShiftTest):
    ...
    def app_setup(self):
        ...
        psql_version = common.cartridge_types['postgresql-9.2']
