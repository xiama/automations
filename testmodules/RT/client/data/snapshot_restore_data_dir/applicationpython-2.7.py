...
def application(environ, start_response):
	...
	if environ['PATH_INFO'] == '/health':
		...
		response_body = '\n'.join(response_body)
                ...
                command1 = "echo '%s' > %s" %(key_string, target_file)
...
<body>
  ...
  <h1>
    Welcome to Python-2.7 running on OpenShift
  </h1>
  <p>
    This is a sample WSGI application running on Python 2.7
  </p>
  <p>
