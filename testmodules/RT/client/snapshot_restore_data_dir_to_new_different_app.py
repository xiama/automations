...
class OpenShiftTest(rhtest.Test):
    ...
    def initialize(self):
        self.info(("[US3629][rhc-client] Archive an existing app "
        ...
        self.diff_name = common.getRandomString(9) 
...
class SnapshotRestoreDataDirToNewDifferentApp(OpenShiftTest):
    def test_method(self):
        ...
        self.add_step("Create a new application with a different name",
                      common.create_app,
                      function_parameters=[self.diff_name, 
                                           self.app_type, 
                                           self.user_email, 
                                           self.user_passwd],
                      expect_return=0,
    ...
    def verify(self, appName, suffix, str_l):
        url=OSConf.get_app_url(appName)
...
def get_suite(conf):
    ...
    suite.add_test(SnapshotRestoreDataDirToNewDifferentApp)
    return suite
