...
class QuickStartBookmarks(QuickStartTest):
    ...
    def __init__(self, config):
        ...
        self.config.summary = "[Runtime][rhc-cartridge]quick-start example: BookMarks"
        self.config.git_upstream_url = "git://github.com/openshift/BookMarks-openshift-quickstart.git"
        self.config.page = "" # means '/'
        self.config.page_pattern = "Welcome to Bookmarks"
